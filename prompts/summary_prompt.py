...
- function_type: One of the following options: CORE, RECV, IRQ, RETURNOK, SKIP, NEEDCHECK, NODRIVER, INIT, LOOP (CORE = NVIC/OS kernel/VTOR critical, no replacement; SysTick is not in CORE)
...
- function_type: 以下选项之一：CORE, RECV, IRQ, RETURNOK, SKIP, NEEDCHECK, NODRIVER, INIT, LOOP（CORE 表示 NVIC/OS 内核/VTOR 关键，不生成替换；SysTick 不属于 CORE）
