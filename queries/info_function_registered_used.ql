...
from FieldAccess fieldAccess, FieldAccess fieldAccess2
where fieldAccess.getType() instanceof FunctionPointerType and
    isRegistrationFieldAccess(fieldAccess2) and
    fieldAccess2.getTarget() = fieldAccess.getTarget() and
    fieldAccess2 != fieldAccess 

select fieldAccess, fieldAccess.getTarget(), getRegisteredFunction(fieldAccess), getRegisteredFunction(fieldAccess).getFile()
