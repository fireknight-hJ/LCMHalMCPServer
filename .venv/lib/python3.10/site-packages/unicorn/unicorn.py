...
try:
    # Python 3.9+ 使用files() API
    # 使用'unicorn'作为包名，而不是'unicorn.unicorn'
    lib_path = str(importlib.resources.files('unicorn').joinpath('lib'))
except AttributeError:
    # Python 3.8 兼容性
    with importlib.resources.path('unicorn', 'lib') as lib_path:
