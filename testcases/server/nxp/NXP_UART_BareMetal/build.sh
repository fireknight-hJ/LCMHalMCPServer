...
export APP_PATH="mcuxsdk/examples/driver_examples/lpuart/polling"
export BUILD_DIR="$PWDDIR/build-uart"
./build_firmware.sh
...
if [ $? -eq 0 ]; then
    ...
    mv -f "build-uart/lpuart_polling.elf" "$SCRIPTDIR/emulate/output.elf" || {
