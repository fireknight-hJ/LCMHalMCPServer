...
export APP_PATH="mcuxsdk/examples/fatfs_examples/fatfs_ramdisk"
export BUILD_DIR="$PWDDIR/build-fatfs"
./build_firmware.sh
...
if [ $? -eq 0 ]; then
    ...
    mv -f "build-fatfs/fatfs_ramdisk.elf" "$SCRIPTDIR/emulate/output.elf" || {
