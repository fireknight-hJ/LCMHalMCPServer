...
# 设置项目构建目录路径
PWDDIR=/Users/jie/mcuxpresso-sdk/mcuxsdk
# 获取当前shell脚本所在目录
...
# 编译项目
echo "开始编译项目..."
export ARMGCC_DIR=/Users/jie/Documents/arm-gnu-toolchain-14.3.rel1-darwin-arm64-arm-none-eabi
source .venv/bin/activate
rm -rf build
west build -b frdmk32l2b examples/cmsis_driver_examples/uart/dma_transfer
...
if [ $? -eq 0 ]; then
    ...
    mv -f "build/cmsis_uart_dma_transfer.elf" "$SCRIPTDIR/emulate/output.elf" || {
