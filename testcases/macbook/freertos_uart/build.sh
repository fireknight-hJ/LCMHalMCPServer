...
# 设置项目构建目录路径
PWDDIR=/Users/jie/Documents/workspace/lcmhalgen/posixGen_Demos/UART_Hyperterminal_IT/STM32CubeIDE/Release
# 获取当前shell脚本所在目录
...
if [ $? -eq 0 ]; then
    ...
    mv -f "UART_Hyperterminal_IT.elf" "$SCRIPTDIR/emulate/output.elf" || {
